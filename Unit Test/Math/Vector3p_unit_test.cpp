...
{
	Vector3p vector(1.0f, 2.0f, 3.0f);
...
{
	const Vector3p vector1(1.0f, 2.0f, 3.0f);
	const Vector3p vector2(4.0f, 5.0f, 6.0f);
	Vector3p result = vector1 + vector2;
...
{
	const Vector3p vector1(1.0f, 2.0f, 3.0f);
	const Vector3p vector2(2.0f, 4.0f, 9.0f);
	Vector3p result = vector2 - vector1;
...
{
	const Vector3p vector(1.0f, 2.0f, 3.0f);
	Vector3p result = vector * 2.0f;
...
static void TEST_CrossProduct()
{
	const Vector3p vector1(1.0f, 2.0f, 3.0f);
	const Vector3p vector2(4.0f, 5.0f, 6.0f);
	const Vector3p result = vector1.cross(vector2);
...
{
	Vector3p vector1(1.0f, 2.0f, 3.0f);
	const Vector3p vector2(4.0f, 5.0f, 6.0f);
	vector1 += vector2;
...
{
	Vector3p vector1(5.0f, 7.0f, 9.0f);
	const Vector3p vector2(4.0f, 5.0f, 6.0f);
	vector1 -= vector2;
...
{
	Vector3p vector(2.0f, 4.0f, 6.0f);
	vector /= 2.0f;
...
{
	const Vector3p vector1(1.0f, 2.0f, 3.0f);
	const Vector3p vector2(1.0f, 2.0f, 3.0f);
	const Vector3p Vector3p(4.0f, 5.0f, 6.0f);

	THROW_IF_FALSE(vector1 == vector2, "Equals operator failed: vectors are not equal");
	THROW_IF_FALSE(vector1 != Vector3p, "Equals operator failed: vectors are equal");
}

static void TEST_Magnitude()
{
	const Vector3p vector(3.0f, 4.0f, 0.0f);
...
{
	const Vector3p vector(3.0f, 4.0f, 0.0f);
	Vector3p result = vector.normalize();
...
{
	const Vector3p vector1(1.0f, 2.0f, 3.0f);
	const Vector3p vector2(4.0f, 6.0f, 3.0f);
...
{
	const Vector3p vector1(0.0f, 0.0f, 0.0f);
	const Vector3p vector2(10.0f, 10.0f, 10.0f);
	Vector3p result = vector1.lerp(vector2, 0.5f);
...
{
	const Vector3p vector1(2.0f, 3.0f, 4.0f);
	const Vector3p vector2(1.0f, 0.5f, 2.0f);
	Vector3p result = vector1.hadamard(vector2);
...
{
	const Vector3p vector(10.0f, 20.0f, 30.0f);
	Vector3p result = vector.clamp(5.0f, 15.0f);
